...
@interface HeChatBlockUserVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HeChatBlockUserVC
...
- (void)initializaiton
{
    ...
    for (NSString *emcuserId in blockList) {
        for (NSDictionary *dict in blockArray) {
            NSString *userId = dict[@"userId"];
            if ([emcuserId isEqualToString:userId]) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *userNick = contactDict[@"userNick"];
    if (userNick == nil) {
        userNick = userId;
    }
